...
### [Movie Mads](https://github.com/Steven1400999/Frontend_Movie_Mads) — Ticket Reservation System
Full stack app for booking movie screenings. Built with **React** (frontend) and **Laravel** (backend), featuring OAuth2/JWT authentication, real-time seat availability control, RESTful APIs, and a **React Native** mobile app via Expo.

`React` `React Native` `TypeScript` `Laravel` `OAuth2` `JWT` `MySQL` `Axios`

---

### [InventiKS](https://github.com/Steven1400999/Proyecto_Inventario) — Inventory Management System
Enterprise-grade inventory system with product management, stock control, and reporting. Security-hardened against XSS, brute force, and session hijacking. Role and permission management included.

`React` `Laravel` `MySQL` `PHP` `REST APIs`

---

### [Cap-tivante](https://github.com/Steven1400999/cap-tivante.github.io) — E-commerce Frontend
Multi-page e-commerce site with product listings, shopping cart, PayPal integration, and user authentication. Responsive and interactive design.

`HTML5` `CSS3` `JavaScript` `PayPal API`

---

## 📈 GitHub Stats

![GitHub Stats](https://github-readme-stats.vercel.app/api?username=Steven1400999&show_icons=true&hide_border=true&theme=onedark)
...
**stevenquezadagonzalez@gmail.com** · Available for full-time roles, contract work, or relocation opportunities in the U.S.
